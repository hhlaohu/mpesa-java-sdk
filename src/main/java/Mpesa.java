...
public class Mpesa {
	...
	/**
	 * @param shortCode     This is the Short Code receiving the amount being transacted.
	 * @param commandID     This is a unique identifier of the transaction type: There are two types of these Identifiers:
	 *                      <p>
	 *                      CustomerPayBillOnline: This is used for Pay Bills shortcodes.
	 *                      <p>
	 *                      CustomerBuyGoodsOnline: This is used for Buy Goods shortcodes.
	 * @param amount        This is the amount being transacted. The parameter expected is a numeric value.
	 * @param MSISDN        This is the phone number initiating the C2B transaction.
	 * @param billRefNumber This is used on CustomerPayBillOnline option only. This is where a customer is expected to enter a unique bill identifier, e.g an Account Number.
	 * @return
	 * @throws IOException
	 */
